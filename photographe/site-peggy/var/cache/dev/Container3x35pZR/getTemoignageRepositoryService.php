...
// Returns the private 'App\Repository\TemoignageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TemoignageRepository.php';

return $this->privates['App\\Repository\\TemoignageRepository'] = new \App\Repository\TemoignageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
