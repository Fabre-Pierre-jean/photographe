...
class __TwigTemplate_27714381ce5374691e286e15e4370dfb10561c5b0c47dd7d0d7045c2c8a720ae extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"jumbotron\">
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13)) {
            // line 14
            echo "            <div class=\"mb-3 alert alert-success\">
...
";
    ...
    {
        return array (  139 => 32,  137 => 31,  130 => 26,  122 => 21,  117 => 18,  109 => 15,  106 => 14,  104 => 13,  101 => 12,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"jumbotron\">
        ...
        {% if app.user %}
            <div class=\"mb-3 alert alert-success\">
                Tu es connecté en tant que {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Logout</a>
            </div>
        {% endif %}
...
{% endblock %}
", "security/login.html.twig", "/home/rl1k/Desktop/peggy_test2/photographe/site-peggy/templates/security/login.html.twig");
    }
}
