...
// Returns the private 'App\Repository\AboutmeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AboutmeRepository.php';

return $this->privates['App\\Repository\\AboutmeRepository'] = new \App\Repository\AboutmeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
